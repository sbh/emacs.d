(custom-set-variables
 ...
 '(package-selected-packages
   '(cider clojure-mode org-roam visual-fill-column org-bullets no-littering auto-package-update yaml-mode web-mode lsp-ui lsp-mode json-mode js2-mode rainbow-mode zop-to-char zenburn-theme which-key volatile-highlights undo-tree super-save smartrep smartparens rainbow-delimiters projectile operate-on-number nlinum move-text magit imenu-anywhere hl-todo guru-mode gitignore-mode gitconfig-mode git-timemachine gist flycheck expand-region exec-path-from-shell elisp-slime-nav editorconfig easy-kill discover-my-major diminish diff-hl crux counsel company browse-kill-ring anzu ag ace-window))
